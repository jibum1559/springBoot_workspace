...
public class Cart {
	...
	//파라미터에 제품과 수량에 관련된 파라밑터를 작성해준 것(Product product, int quantity)
	public void addToCart(Product product, int quantity) {
		//장바구니에 이미 담겨져 있는 CartItem 들을 확인하기 위해 반복문을 설정
		...
		//새로운 CartItem 객체를 생성해서 items 새로운 CartItem을 새로운 장바구니에 추가
